/**
 * Compat shim — re-exports from @wmt/domain
 * Keep legacy export names for backward compatibility with existing tests.
 */
import { z } from 'zod'
...
// Extended domain re-exports (available via direct @wmt/domain package imports)
// export { ClassificationSchema } from '@wmt/domain'
